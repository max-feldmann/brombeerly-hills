...
export const metadata: Metadata = {
    title: "Mitmachen",
    description: "Hier findest du alle Möglichkeiten, wie du uns dabei unterstützen kannst, eine uralte Streuobstwiese in Bamberg zu retten.",
}
            ...
            <section className='mb-20'>
                <div className='container mx-auto lg:my-28 | border-b lg:border border-gray-700'>
                    <div className="p-6 md:p-10 lg:p-20 | flex flex-col lg:items-center items-start">
                        <div className='lg:max-w-2/3 flex flex-col items-start lg:items-center'>
